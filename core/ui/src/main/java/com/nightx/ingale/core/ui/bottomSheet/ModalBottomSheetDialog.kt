...
/** !!Copy from androidx.compose.material3.ModalBottomSheet!! */
        ...
        dialogLayout =
            ModalBottomSheetDialogLayout(
                ...
                .apply {
                    ...
                    setTag(ComposeUiR.id.compose_view_saveable_id_tag, "Dialog:$dialogId")
        ...
        if (backCallback == null) {
            backCallback =
                if (Build.VERSION.SDK_INT >= 34) {
                    Api34Impl.createBackCallback(onDismissRequest)
                } else {
